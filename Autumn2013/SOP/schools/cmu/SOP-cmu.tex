...
The Computer Science MS Program at Carnegie Mellon, with full access to graphics courses with focuses on character animation, natural phenomena simulation, and other sister disciplines, offers the challenges and opportunities I seek. This include the opportunity to learn from faculties such as Professor~Nancy~Pollard and Professor~Jessica~Hodkins, whose design of intuitive controls for humanoid or non-humanoid character animation based on robotics sets the idustrial standard. The challenge of working alongside the best and brightest student body will also be invaluable. Most importantly, your unique curriculum allows us students to freely customize our own courses of study under advisors' approval, and makes it possible for me to develop a prominant specialization according to my stable academic interest. Hence, I full-heartedly anticipate in studying computer science at Carnegie Mellon. With the guidance from your faculty, my diverse experiences and dedication to excel, I am confident in extending the frontiers of computer graphics as well as commencing my career as an industrial researcher in computer animation with a promising start.
